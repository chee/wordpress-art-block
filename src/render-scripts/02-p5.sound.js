...
/******/ (function (modules) {
	...
	/******/ [
			...
			!((__WEBPACK_AMD_DEFINE_RESULT__ = function () {
				...
				return (
					...
					Object.defineProperty(a, "context", {
						...
						set: function (t) {
							(e =
								a.Context && t instanceof a.Context
									? t
									: new a.Context(t)),
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (n) {
				...
				return (
					...
					(n.Signal.prototype.connect =
						n.SignalBase.prototype.connect),
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			/* WEBPACK VAR INJECTION */ (function (global) {
				...
				/* harmony import */ var startaudiocontext__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(22);
				/* harmony import */ var startaudiocontext__WEBPACK_IMPORTED_MODULE_0___default =
					/*#__PURE__*/ __webpack_require__.n(
						startaudiocontext__WEBPACK_IMPORTED_MODULE_0__
					);
				/* harmony import */ var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(0);
				/* harmony import */ var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1___default =
					/*#__PURE__*/ __webpack_require__.n(
						Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__
					);
				/* harmony import */ var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(12);
				/* harmony import */ var Tone_core_Context__WEBPACK_IMPORTED_MODULE_2___default =
					/*#__PURE__*/ __webpack_require__.n(
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
				...
				return (
					...
					(o.TimelineSignal.prototype.setValueAtTime = function (
						e,
						t
					) {
						return (
					...
					(o.TimelineSignal.prototype.linearRampToValueAtTime =
						function (e, t) {
							return (
								(e = this._fromUnits(e)),
								(t = this.toSeconds(t)),
					...
					(o.TimelineSignal.prototype.exponentialRampToValueAtTime =
						function (e, t) {
							t = this.toSeconds(t);
							var i = this._searchBefore(t);
							i &&
								0 === i.value &&
								this.setValueAtTime(this._minOutput, i.time),
								(e = this._fromUnits(e));
					...
					(o.TimelineSignal.prototype.setTargetAtTime = function (
						e,
						t,
						i
					) {
					...
					(o.TimelineSignal.prototype.cancelScheduledValues =
						function (e) {
							return (
								(e = this.toSeconds(e)),
						...
						if (i && i.time === e)
							...
							n &&
								...
								n.type === o.TimelineSignal.Type.Linear
									? this.linearRampToValueAtTime(t, e)
									: n.type ===
											o.TimelineSignal.Type.Exponential &&
									  this.exponentialRampToValueAtTime(t, e)),
								this.setValueAtTime(t, e);
						}
						return this;
					}),
					(o.TimelineSignal.prototype.linearRampToValueBetween =
						function (e, t, i) {
							return (
								this.setRampPoint(t),
								this.linearRampToValueAtTime(e, i),
								this
							);
						}),
					(o.TimelineSignal.prototype.exponentialRampToValueBetween =
						function (e, t, i) {
							return (
								this.setRampPoint(t),
								this.exponentialRampToValueAtTime(e, i),
								this
							);
						}),
					...
					(o.TimelineSignal.prototype.connect =
						o.SignalBase.prototype.connect),
					(o.TimelineSignal.prototype._exponentialApproach =
						function (e, t, i, n, a) {
					...
					(o.TimelineSignal.prototype._exponentialInterpolate =
						function (e, t, i, n, a) {
							return (
					...
					(o.TimelineSignal.prototype._curveInterpolate = function (
						e,
						t,
						i,
						n
						...
						return r === s
							? o
							: this._linearInterpolate(s, o, r, p, l * (a - 1));
					}),
				...
				return (
					(o.Clock = function () {
						...
						(this.callback = t.callback),
							...
							(this.ticks = 0),
							(this._state = new o.TimelineState(
								o.State.Stopped
							)),
				...
				return (
					...
					(c.SignalBase.prototype.connect = function (e, n, a) {
						return (
							...
							(c.TimelineSignal &&
								c.TimelineSignal === e.constructor)
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
				return (
					...
					(o.Time.prototype.toNotation = function () {
						...
						return o.split("+").length < e.split("+").length
							? o
							: e;
					}),
					(o.Time.prototype._toNotationHelper = function (t, e) {
						for (
							var o = this._notationToUnits(e[e.length - 1]),
								n = "",
								i = 0;
							i < e.length;
							i++
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (n) {
				return (
					(n.TimeBase = function (e, t) {
						...
						if (
							((this._expr = this._noOp), e instanceof n.TimeBase)
						)
							this.copy(e);
					...
					(n.TimeBase.prototype._primaryExpressions = {
						...
						t: {
							...
							method: function (e) {
								return (
									(e = parseInt(e)),
									this._beatsToUnits(8 / (3 * parseInt(e)))
								);
							},
						},
						m: {
							...
							method: function (e) {
								return this._beatsToUnits(
									parseInt(e) * this._timeSignature()
								);
							},
						},
						i: {
					...
					(n.TimeBase.prototype._tokenize = function (e) {
						...
						function i(e, t) {
							...
							throw new SyntaxError(
								"Tone.TimeBase: Unexpected token " + e
							);
						}
						return {
							next: function () {
					...
					(n.TimeBase.prototype._parseBinary = function (e, t) {
						...
						for (
							var n = e.peek();
							n &&
							this._matchGroup(n, this._binaryExpressions, t);
					...
					(n.TimeBase.prototype._pushExpr = function (e, t, r) {
						return (
							e instanceof n.TimeBase ||
								(e = new this.constructor(e, r)),
							(this._expr = this._binaryExpressions[
								t
							].method.bind(this, this._expr, e._expr)),
							this
						);
					}),
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (a) {
				...
				return (
					...
					(a.Param.prototype.linearRampToValueAtTime = function (
						t,
						e
					) {
						return (
					...
					(a.Param.prototype.exponentialRampToValueAtTime = function (
						t,
						e
					) {
						return (
					...
					(a.Param.prototype.exponentialRampToValue = function (
						t,
						e,
						i
					) {
					...
					(a.Param.prototype.setValueCurveAtTime = function (
						t,
						e,
						i
					) {
						for (var a = 0; a < t.length; a++)
							t[a] = this._fromUnits(t[a]);
						return (
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (i) {
				...
				return (
					...
					(i.Timeline.prototype.getAfter = function (e) {
						var i = this._search(e);
						return i + 1 < this._timeline.length
							? this._timeline[i + 1]
							: null;
					}),
					...
					(i.Timeline.prototype.cancelBefore = function (e) {
						if (this._timeline.length) {
							var i = this._search(e);
							0 <= i &&
								(this._timeline = this._timeline.slice(i + 1));
						}
						return this;
					}),
					...
					(i.Timeline.prototype._iterate = function (e, i, t) {
						...
						if (
							((this._iterating = !1), 0 < this._toRemove.length)
						) {
							for (var r = 0; r < this._toRemove.length; r++) {
								var s = this._timeline.indexOf(
									this._toRemove[r]
								);
					...
					function (t, e, n) {
						...
						return (
							(function e(t, n, i) {
								if (
									Array.isArray(t) ||
									(NodeList && t instanceof NodeList)
								)
			...
			!(function () {
				...
				function p(e) {
					...
					this.parameters.forEach(function (e, t) {
						var r =
							s[++i] || (s[i] = new Float32Array(o.bufferSize));
				...
				(self.AudioWorkletNode = function (e, t, r) {
					var o = f(e)[t],
						n = e.createScriptProcessor(
							void 0,
							2,
							r && r.outputChannelCount
								? r.outputChannelCount[0]
								: 2
						);
  ...
  */
				...
				if (
					...
					if (typeof AudioContext.prototype.createGain !== "function")
						AudioContext.prototype.createGain =
							AudioContext.prototype.createGainNode;
					if (
						typeof AudioContext.prototype.createDelay !== "function"
					)
			...
			var isWAVSupported = function isWAVSupported() {
				return (
					!!el.canPlayType && el.canPlayType('audio/wav; codecs="1"')
				);
			};
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
				(o.Frequency = function (e, t) {
					...
					(o.Frequency.prototype._primaryExpressions.tr = {
						...
						method: function (e, t, r) {
							...
							return (
								...
								t &&
									"0" !== t &&
									(n *= this._beatsToUnits(parseFloat(t))),
								r &&
									"0" !== r &&
									(n *= this._beatsToUnits(
										parseFloat(r) / 4
						...
						return (
							(this._expr = function (e, t) {
								for (
									...
									n[o] =
										r * this.intervalToFrequencyRatio(t[o]);
								return n;
							}.bind(this, this._expr, e)),
							this
						);
					...
					(o.Frequency.prototype._ticksToUnits = function (e) {
						return (
							1 /
							((60 * e) /
								(o.Transport.bpm.value * o.Transport.PPQ))
						);
					}),
					(o.Frequency.prototype._beatsToUnits = function (e) {
						return (
							1 / o.TimeBase.prototype._beatsToUnits.call(this, e)
						);
					}),
				...
				return (
					...
					(o.Frequency.prototype.frequencyToMidi = function (e) {
						return (
							69 + (12 * Math.log(e / o.Frequency.A4)) / Math.LN2
						);
					}),
					o.Frequency
				);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
				return (
					...
					(o.TransportTime.prototype._unaryExpressions =
						Object.create(o.Time.prototype._unaryExpressions)),
					...
					(o.TransportTime.prototype.toSeconds = function () {
						return (
							this._expr() +
							(this._plusNow ? o.Transport.seconds : 0)
						);
					}),
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (p) {
				...
				function r(e, n, r) {
					var t = new e();
					return (
						r._eval(n[0]).connect(t, 0, 0),
						r._eval(n[1]).connect(t, 0, 1),
						t
					);
				}
				function t(e, n, r) {
					...
					(p.Expr = function () {
						...
						try {
							...
							throw (
								(this._disposeNodes(),
								new Error(
									"Tone.Expr: Could evaluate expression: " + n
								))
							);
						}
						this.output = t;
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			(__WEBPACK_AMD_DEFINE_RESULT__ = function (t) {
				...
				return (
					...
					(t.TimelineState.prototype.setStateAtTime = function (
						e,
						t
					) {
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			var main_Main = function Main() {
				...
				this.limiter =
					audiocontext["a" /* default */].createDynamicsCompressor();
			...
			var processorNames_default =
				/*#__PURE__*/ __webpack_require__.n(processorNames);
			...
			function _checkFileFormats(paths) {
				...
				if (typeof paths === "string") {
					...
					if (
						["mp3", "wav", "ogg", "m4a", "aac"].indexOf(extTest) >
						-1
					) {
						if (!p5.prototype.isFileSupported(extTest)) {
							...
							for (
								var _i = 0;
								_i < main.extensions.length;
								_i++
							) {
								var _extension = main.extensions[_i];

								var _supported =
									p5.prototype.isFileSupported(_extension);
						...
						for (var _i3 = 0; _i3 < main.extensions.length; _i3++) {
							...
							var _supported2 =
								p5.prototype.isFileSupported(_extension2);
			...
			function convertToWav(audioBuffer) {
				...
				var buffer = new window.ArrayBuffer(
   ...
   */
			...
			function loadAudioWorkletModules() {
				return Promise.all(
					moduleSources.map(function (moduleSrc) {
						...
						return audioWorklet_ac.audioWorklet.addModule(
							objectURL
						);
					})
				);
					...
					(function () {
						function _Panner(input, output, numInputChannels) {
							...
							if (numInputChannels > 1) {
								this.splitter =
									panner_ac.createChannelSplitter(2);
						...
						_createClass(_Panner, [
							{
								...
								value: function pan(val, tFromNow) {
									...
									this.left.gain.linearRampToValueAtTime(
										leftVal,
										t
									);
							...
							},
							{
								...
								value: function inputChannels(numChannels) {
									if (numChannels === 1) {
										...
										if (
											typeof this.splitter === "undefined"
										) {
											this.splitter =
												panner_ac.createChannelSplitter(
													2
												);
										}
			...
			function soundfile_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					soundfile_defineProperties(
					...
					function SoundFile(paths, onload, onerror, whileLoading) {
						...
						if (typeof paths !== "undefined") {
							if (
								...
								var path =
									p5.prototype._checkFileFormats(paths);
					...
					soundfile_createClass(SoundFile, [
						...
						},
						{
							...
							value: function play(
								...
								if (!this.output) {
									console.warn(
										"SoundFile.play() called after dispose"
									);
									return;
								}
								...
								if (this.buffer) {
									...
									this.bufferSourceNode =
										this._initSourceNode(); // garbage collect counterNode and create a new one
									...
									if (_cueStart) {
										if (
											_cueStart >= 0 &&
											_cueStart < this.buffer.duration
										) {
						...
						},
						{
							...
							value: function playMode(str) {
								...
								if (
									...
									for (
										var i = 0;
										i < this.bufferSourceNodes.length - 1;
										i++
									) {
										var now = main.audiocontext.currentTime;
						...
						},
						{
							...
							value: function currentTime() {
								return this.reversed
									? Math.abs(
											this._lastPos - this.buffer.length
									  ) / soundfile_ac.sampleRate
									...
									for (
										...
										if (
											...
											try {
												...
												console.warn(
													"no buffer source node to dispose"
												);
											}
						...
						},
						{
							...
							value: function setBuffer(buf) {
								...
								for (
									...
									var channel =
										newBuffer.getChannelData(channelNum);
						...
						},
						{
							...
							value: function _initCounterNode() {
								...
								self._workletNode.port.onmessage = function (
									event
								) {
								...
								cNode.buffer = _createCounterBuffer(
									self.buffer
								);
								cNode.playbackRate.setValueAtTime(
									self.playbackRate,
									now
								);
								cNode.connect(self._workletNode);

								self._workletNode.connect(
									p5.soundOut._silentNode
								);
						...
						},
						{
							...
							value: function _initSourceNode() {
								var bufferSourceNode =
									soundfile_ac.createBufferSource();
						...
						},
						{
							...
							value: function _onTimeUpdate(position) {
								var playbackTime =
									position / this.buffer.sampleRate;
								var cueLength = this._cues.length;
								...
								for (var i = 0; i < cueLength; i++) {
									...
									if (
										leftLimit <= callbackTime &&
										callbackTime <= rightLimit
									) {
			...
			function amplitude_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					amplitude_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
				...
				(function () {
					function FFT(smoothing, bins) {
						...
						this.input = this.analyser =
							main.audiocontext.createAnalyser();
						...
						},
						{
							...
							value: function getCentroid() {
								...
								if (centroid_normalization !== 0) {
									mean_freq_index =
										cumulative_sum / centroid_normalization;
								}

								var spec_centroid_freq =
									mean_freq_index *
									(nyquist / this.freqDomain.length);
									...
									linearAverages[groupIndex] =
										linearAverages[groupIndex] !== undefined
											? (linearAverages[groupIndex] +
													spectrum[specIndex]) /
											  2
											: spectrum[specIndex]; // Increase the group index when the last element of the group is processed

									if (
										specIndex % spectrumStep ===
										spectrumStep - 1
									) {
										groupIndex++;
									}
			...
			var Multiply_default =
				/*#__PURE__*/ __webpack_require__.n(Multiply);
			...
			function oscillator_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					oscillator_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
					...
					oscillator_createClass(Oscillator, [
						{
							...
							value: function start(time, f) {
								...
								if (!this.started) {
									...
									this.oscillator =
										main.audiocontext.createOscillator();
						...
						},
						{
							...
							value: function phase(p) {
								...
								if (!this.dNode) {
									// create a delay node
									this.dNode =
										main.audiocontext.createDelay(); // put the delay node in between output and panner
								...
								this.dNode.delayTime.setValueAtTime(
									delayAmt,
									now
								);
							},
								...
								if (arguments.length === 4) {
									mapOutMin =
										p5.prototype.map(
											...
											0,
											1
										) - 0.5; //find a way to get rid of p5.prototype ?
				...
				(function (_Oscillator) {
					...
					function SinOsc(freq) {
						...
						return _possibleConstructorReturn(
							this,
							_getPrototypeOf(SinOsc).call(this, freq, "sine")
						);
					}
			...
			var TriOsc =
				...
				(function (_Oscillator2) {
					...
					function TriOsc(freq) {
						...
						return _possibleConstructorReturn(
							this,
							_getPrototypeOf(TriOsc).call(this, freq, "triangle")
						);
					}
			...
			var SawOsc =
				...
				(function (_Oscillator3) {
					...
					function SawOsc(freq) {
						...
						return _possibleConstructorReturn(
							this,
							_getPrototypeOf(SawOsc).call(this, freq, "sawtooth")
						);
					}
			...
			var SqrOsc =
				...
				(function (_Oscillator4) {
					...
					function SqrOsc(freq) {
						...
						return _possibleConstructorReturn(
							this,
							_getPrototypeOf(SqrOsc).call(this, freq, "square")
						);
					}
			...
			var TimelineSignal_default =
				/*#__PURE__*/ __webpack_require__.n(TimelineSignal);
			...
			p5.Envelope.prototype.triggerAttack = function (
				unit,
				secondsFromNow
			) {
				var now = main.audiocontext.currentTime;
				...
				if (this.isExponential === true) {
					...
					valToSet = this.checkExpInput(
						this.control.getValueAtTime(t)
					);
			...
			p5.Envelope.prototype.ramp = function (
				unit,
				secondsFromNow,
				v1,
				v2
				...
				var destination2 =
					typeof v2 !== "undefined"
						? this.checkExpInput(v2)
						: undefined; // connect env to unit if not already connected
				...
				var currentVal = this.checkExpInput(
					this.control.getValueAtTime(t)
				); // this.control.cancelScheduledValues(t);
				//if it's going up
			...
			p5.Envelope.prototype.scale = function (
				inMin,
				inMax,
				outMin,
				outMax
			...
			var _whiteNoiseBuffer = (function () {
				...
				var whiteBuffer = main.audiocontext.createBuffer(
					1,
					bufferSize,
					main.audiocontext.sampleRate
				);
			...
			var _pinkNoiseBuffer = (function () {
				var bufferSize = 2 * main.audiocontext.sampleRate;
				var pinkBuffer = main.audiocontext.createBuffer(
					1,
					bufferSize,
					main.audiocontext.sampleRate
				);
			...
			var _brownNoiseBuffer = (function () {
				var bufferSize = 2 * main.audiocontext.sampleRate;
				var brownBuffer = main.audiocontext.createBuffer(
					1,
					bufferSize,
					main.audiocontext.sampleRate
				);
			...
			var noise_Noise =
				...
				(function (_Oscillator) {
					...
					function Noise(type) {
						...
						_this = noise_possibleConstructorReturn(
							this,
							noise_getPrototypeOf(Noise).call(this)
						);
						var assignType;
						delete _this.f;
						delete _this.freq;
					...
					noise_createClass(Noise, [
						...
						},
						{
							...
							value: function start() {
								...
								this.noise =
									main.audiocontext.createBufferSource();
			...
			var pulse_Pulse =
				...
				(function (_Oscillator) {
					...
					function Pulse(freq, w) {
						...
						_this = pulse_possibleConstructorReturn(
							this,
							pulse_getPrototypeOf(Pulse).call(
								this,
								freq,
								"sawtooth"
							)
					...
					audioin_createClass(AudioIn, [
						{
							...
							value: function start(
								...
								var audioSource =
									main.inputSources[self.currentSource];
								var constraints = {
									audio: {
										sampleRate:
											main.audiocontext.sampleRate,
								...
								window.navigator.mediaDevices
									...
									.then(function (stream) {
										...
										self.mediaStream =
											main.audiocontext.createMediaStreamSource(
												stream
											);
						...
						},
						{
							...
							value: function amp(vol, t) {
								if (t) {
									...
									this.output.gain.linearRampToValueAtTime(
										vol,
										rampTime + main.audiocontext.currentTime
									);
								} else {
									this.output.gain.cancelScheduledValues(
										main.audiocontext.currentTime
								...
								return new Promise(function (resolve, reject) {
									window.navigator.mediaDevices
										...
										.then(function (devices) {
											main.inputSources = devices.filter(
												function (device) {
													return (
														device.kind ===
														"audioinput"
						...
						},
						{
							...
							value: function setSource(num) {
								if (
									main.inputSources.length > 0 &&
									num < main.inputSources.length
								) {
									// set the current source
									this.currentSource = num;
									console.log(
										"set source to ",
										main.inputSources[this.currentSource]
									);
								} else {
			...
			var CrossFade_default =
				/*#__PURE__*/ __webpack_require__.n(CrossFade);
			...
			var Filter =
				...
				(function (_Effect) {
					...
					function Filter(type) {
						...
						_this = filter_possibleConstructorReturn(
							this,
							filter_getPrototypeOf(Filter).call(this)
					...
					filter_createClass(Filter, [
						...
						},
						{
							...
							value: function dispose() {
								// remove reference from soundArray
								_get(
									filter_getPrototypeOf(Filter.prototype),
									"dispose",
									this
								).call(this);
			...
			var LowPass =
				...
				(function (_Filter) {
					...
					function LowPass() {
						...
						return filter_possibleConstructorReturn(
							this,
							filter_getPrototypeOf(LowPass).call(this, "lowpass")
						);
					}
			...
			var HighPass =
				...
				(function (_Filter2) {
					...
					function HighPass() {
						...
						return filter_possibleConstructorReturn(
							this,
							filter_getPrototypeOf(HighPass).call(
								this,
								"highpass"
							)
						);
			...
			var BandPass =
				...
				(function (_Filter3) {
					...
					function BandPass() {
						...
						return filter_possibleConstructorReturn(
							this,
							filter_getPrototypeOf(BandPass).call(
								this,
								"bandpass"
							)
						);
			...
			function eqFilter_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					eqFilter_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			var eqFilter_EQFilter =
				...
				(function (_Filter) {
					...
					function EQFilter(freq, res) {
						...
						_this = eqFilter_possibleConstructorReturn(
							this,
							eqFilter_getPrototypeOf(EQFilter).call(
								this,
								"peaking"
							)
						);
					...
					eqFilter_createClass(EQFilter, [
						...
						},
						{
							...
							value: function drywet() {
								console.warn(
									"`drywet()` is not available for p5.EQ bands."
								);
							},
						},
						{
			...
			function eq_possibleConstructorReturn(self, call) {
				if (
					call &&
					(eq_typeof(call) === "object" || typeof call === "function")
				) {
					return call;
				}
			...
			var eq_EQ =
				...
				(function (_Effect) {
					...
					function EQ(_eqsize) {
						...
						_this = eq_possibleConstructorReturn(
							this,
							eq_getPrototypeOf(EQ).call(this)
						...
						for (var i = 0; i < _eqsize; i++) {
							...
							if (i > 0) {
								_this.bands[i - 1].connect(
									_this.bands[i].biquad
								);
							} else {
					...
					eq_createClass(EQ, [
						...
						},
						{
							...
							value: function dispose() {
								eq_get(
									eq_getPrototypeOf(EQ.prototype),
									"dispose",
									this
								).call(this);
			...
			function listener3d_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					listener3d_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			function panner3d_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					panner3d_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			var Panner3D =
				...
				(function (_Effect) {
					...
					function Panner3D() {
						...
						_this = panner3d_possibleConstructorReturn(
							this,
							panner3d_getPrototypeOf(Panner3D).call(this)
						);
						/**
					...
					panner3d_createClass(Panner3D, [
						...
						},
						{
							...
							value: function dispose() {
								panner3d_get(
									panner3d_getPrototypeOf(Panner3D.prototype),
									"dispose",
									this
								).call(this);
			...
			var delay_Delay =
				...
				(function (_Effect) {
					...
					function Delay() {
						...
						_this = delay_possibleConstructorReturn(
							this,
							delay_getPrototypeOf(Delay).call(this)
						);
						...
						_this._leftFilter.biquad.frequency.setValueAtTime(
							1200,
							_this.ac.currentTime
						);

						_this._rightFilter.biquad.frequency.setValueAtTime(
							1200,
							_this.ac.currentTime
						);

						_this._leftFilter.biquad.Q.setValueAtTime(
							0.3,
							_this.ac.currentTime
						);

						_this._rightFilter.biquad.Q.setValueAtTime(
							0.3,
							_this.ac.currentTime
						); // graph routing
						...
						_this._leftFilter.biquad.gain.setValueAtTime(
							1,
							_this.ac.currentTime
						);

						_this._rightFilter.biquad.gain.setValueAtTime(
							1,
							_this.ac.currentTime
						); // default routing
					...
					delay_createClass(Delay, [
						...
						},
						{
							...
							value: function dispose() {
								delay_get(
									delay_getPrototypeOf(Delay.prototype),
									"dispose",
									this
								).call(this);
			...
			var Reverb =
				...
				(function (_Effect) {
					...
					function Reverb() {
						...
						_this = reverb_possibleConstructorReturn(
							this,
							reverb_getPrototypeOf(Reverb).call(this)
						);
					...
					reverb_createClass(Reverb, [
						...
						},
						{
							...
							value: function _buildImpulse() {
								...
								var impulse = this.ac.createBuffer(
									2,
									length,
									rate
								);
						...
						},
						{
							...
							value: function dispose() {
								reverb_get(
									reverb_getPrototypeOf(Reverb.prototype),
									"dispose",
									this
								).call(this);
			...
			var reverb_Convolver =
				...
				(function (_Reverb) {
					...
					function Convolver(path, callback, errorCallback) {
						...
						_this2 = reverb_possibleConstructorReturn(
							this,
							reverb_getPrototypeOf(Convolver).call(this)
						);
						/**
					...
					reverb_createClass(Convolver, [
						{
							...
							value: function _loadBuffer(
								...
								var path =
									p5.prototype._checkFileFormats(_path);

								var self = this;
								var errorTrace = new Error().stack;
								var ac = Object(
									audiocontext["b" /* getAudioContext */]
								)();
								var request = new XMLHttpRequest();
						...
						},
						{
							...
							value: function toggleImpulse(id) {
								if (
									typeof id === "number" &&
									id < this.impulses.length
								) {
									this._setBuffer(
										this.impulses[id].audioBuffer
									);
								}
						...
						},
						{
							...
							value: function dispose() {
								reverb_get(
									reverb_getPrototypeOf(Convolver.prototype),
									"dispose",
									this
								).call(this); // remove all the Impulse Response buffers
					...
					metro_createClass(Metro, [
						{
							...
							value: function ontick(tickTime) {
								...
								var secondsFromNow =
									tickTime - main.audiocontext.currentTime;
						...
						},
						{
							...
							value: function getBPM() {
								return (
									(this.clock.getRate() / this.tatums) * 60
								);
							},
						},
						{
			...
			function compressor_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					compressor_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			var Compressor =
				...
				(function (_Effect) {
					...
					function Compressor() {
						...
						_this = compressor_possibleConstructorReturn(
							this,
							compressor_getPrototypeOf(Compressor).call(this)
						);
						/**
						 *
			...
			function peakDetect_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					peakDetect_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
					...
					peakDetect_createClass(PeakDetect, [
						{
							...
							value: function update(fftObject) {
								var nrg = (this.energy =
									fftObject.getEnergy(this.f1, this.f2) /
									255);
			...
			function soundRecorder_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
			...
			var soundRecorder_SoundRecorder =
				...
				(function () {
					function SoundRecorder() {
						...
						var workletBufferSize = (this.bufferSize =
							safeBufferSize(1024));
						this._workletNode = new AudioWorkletNode(
							soundRecorder_ac,
			...
			/* harmony default export */ var soundRecorder =
				soundRecorder_SoundRecorder;
			...
			function distortion_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					distortion_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			var Distortion =
				...
				(function (_Effect) {
					...
					function Distortion(amount, oversample) {
						...
						_this = distortion_possibleConstructorReturn(
							this,
							distortion_getPrototypeOf(Distortion).call(this)
						);
						...
						var curveAmount = p5.prototype.map(
							amount,
							0.0,
							1.0,
							0,
						...
						_this.waveShaperNode.curve =
							makeDistortionCurve(curveAmount);
			...
			function audioVoice_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					audioVoice_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			/* harmony default export */ var audioVoice_0 =
				audioVoice_AudioVoice;
			...
			function monosynth_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					monosynth_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			var monosynth_MonoSynth =
				...
				(function (_AudioVoice) {
					...
					function MonoSynth() {
						...
						_this = monosynth_possibleConstructorReturn(
							this,
							monosynth_getPrototypeOf(MonoSynth).call(this)
						);
						...
						main.soundArray.push(
							monosynth_assertThisInitialized(_this)
						);
						/**
						 * Getters and Setters
			...
			function onsetDetect_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					onsetDetect_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
			...
			function polysynth_createClass(
				Constructor,
				protoProps,
				staticProps
			) {
				if (protoProps)
					polysynth_defineProperties(
						Constructor.prototype,
						protoProps
					);
				if (staticProps)
					...
					polysynth_createClass(PolySynth, [
						...
						},
						{
							...
							value: function noteAttack(_note, _velocity) {
								...
								var acTime =
									main.audiocontext.currentTime +
									secondsFromNow; //Convert note to frequency if necessary. This is because entries into this.notes
								...
								if (
									this.notes[note] &&
									this.notes[note].getValueAtTime(acTime) !==
										null
								) {
								...
								if (
									...
									currentVoice = Math.max(
										~~this._voicesInUse.getValueAtTime(
											acTime
										),
										0
									);
								...
								this.notes[note] =
									new TimelineSignal_default.a();
								this.notes[note].setValueAtTime(
									currentVoice,
									acTime
								...
								var previousVal =
									this._voicesInUse._searchBefore(acTime) ===
									null
										? 0
										: this._voicesInUse._searchBefore(
												acTime
										  ).value;

								this._voicesInUse.setValueAtTime(
									previousVal + 1,
									acTime
						...
						},
						{
							...
							value: function _updateAfter(time, value) {
								if (
									this._voicesInUse._searchAfter(time) ===
									null
								) {
									return;
								} else {
									this._voicesInUse._searchAfter(
										time
									).value += value;
							...
							value: function noteRelease(_note, secondsFromNow) {
								...
								if (
									...
									var previousVal = Math.max(
										~~this._voicesInUse.getValueAtTime(t)
											.value,
										1
									);
			...
			var Signal_Signal = function Signal() {
				...
				console.warn(
					"p5.Signal is deprecated , Use Tone.js Signal instead "
				);
			};

			/* harmony default export */ var deprecations_Signal =
				Signal_Signal;
			// CONCATENATED MODULE: ./app.js

			p5.prototype.getAudioContext =
				audiocontext["b" /* getAudioContext */];
			p5.prototype.userStartAudio =
				audiocontext["c" /* userStartAudio */];
